...
const outDir = path.join(projectRoot, "marketing-assets", "app-store-iphone-lite"); // Using existing output folder
const url = 'http://localhost:3000/screenshots-export';
...
async function main() {
  console.log("🏒 Generating App Store Images (V2 - HTML/Next.js Render)\n");
  ...
  await page.setViewport({ width: 6000, height: 3500, deviceScaleFactor: 1 });
  ...
  console.log(`\n✅ All new App Store screenshots generated at ${outDir}`);
}
