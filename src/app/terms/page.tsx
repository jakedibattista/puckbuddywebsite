  ...
  return (
    <div className="container mx-auto p-10">
      ...
      <ul className="list-disc list-inside mb-4">
        <li>Systematically retrieving data or other content from the App to create a collection or database without written permission from us.</li>
      ...
      <ul className="list-disc list-inside mb-4">
        ...
        <li>The accuracy of the analysis may vary based on video quality, lighting conditions, camera angle, and other factors beyond our control.</li>
        <li>We do not guarantee the accuracy, completeness, or usefulness of any analysis or feedback provided by the App.</li>
        <li>The analysis results are estimates and should be used as a tool to help improve your technique, not as definitive measurements.</li>
